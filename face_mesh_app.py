...
if app_mode == 'About App':
    st.markdown(
        'In this application we are using **MediaPipe** for creating a Face mash Application. **Streamlit** is an open source app framework in Python language. It helps us create web apps for data science and machine learning in a short time. ')
    st.markdown(
        """
        <style>
        [data-testid="stSidebar][aria-expanded="true] > div:first-child {
